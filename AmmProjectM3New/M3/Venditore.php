...
function content($state)
{
    switch ($state)
    {
        ...
        case 2:
        {
            if(isset($_REQUEST['conferma']) && isset($_REQUEST['nome']) && isset($_REQUEST['img']) && isset($_REQUEST['descr']) && isset($_REQUEST['prezzo']) && isset($_REQUEST['disponibili']))
            {
                $_SESSION['articolo']=new Articolo($_SESSION['utente'], $_REQUEST['nome'], $_REQUEST['prezzo'], $_REQUEST['descr'], $_REQUEST['disponibili'], $_REQUEST['img']);
